...
final _containerChr = CurrencyLocalizationContainer._(
  locale: r"chr",
  currencies: {
    "AED": CurrencyLocalization._(
      displayName: r"ᏌᏊ ᎢᏳᎾᎵᏍᏔᏅ ᎡᎳᏈ ᎢᎹᎵᏘᏏ ᎠᏕᎳ",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "AFN": CurrencyLocalization._(
      displayName: r"ᎠᏫᎨᏂᏍᏖᏂ ᎠᏕᎳ",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "ALL": CurrencyLocalization._(
      displayName: r"ᎠᎵᏇᏂᏯ ᎠᏕᎳ",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "AMD": CurrencyLocalization._(
      displayName: r"ᎠᎵᎻᏂᎠ ᎠᏕᎳ",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
