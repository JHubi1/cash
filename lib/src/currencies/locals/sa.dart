...
final _containerSa = CurrencyLocalizationContainer._(
  locale: r"sa",
  currencies: {
    "BRL": CurrencyLocalization._(
      displayName: r"ब्राजीली रियाल",
    ...
    "EUR": CurrencyLocalization._(
      displayName: r"फिरङ्गिन् मुद्रा",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "GBP": CurrencyLocalization._(
      displayName: r"आङ्ग्लदेशीयः पाउंड",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "INR": CurrencyLocalization._(
      displayName: r"भारतीय रूप्यकम्",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
