...
final _containerSe = CurrencyLocalizationContainer._(
  locale: r"se",
  currencies: {
    ...
    "FIM": CurrencyLocalization._(
      displayName: r"suoma márkki",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "NOK": CurrencyLocalization._(
      displayName: r"norgga kruvdno",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "SEK": CurrencyLocalization._(
      displayName: r"ruoŧŧa kruvdno",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "XAG": CurrencyLocalization._(
      displayName: r"uns silba",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "XAU": CurrencyLocalization._(
      displayName: r"uns golli",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
  },
