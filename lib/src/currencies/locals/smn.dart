...
final _containerSmn = CurrencyLocalizationContainer._(
  locale: r"smn",
  currencies: {
    "DKK": CurrencyLocalization._(
      displayName: r"Tanska ruvnâ",
    ...
    "ISK": CurrencyLocalization._(
      displayName: r"Island ruvnâ",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "NOK": CurrencyLocalization._(
      displayName: r"Taažâ ruvnâ",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
    "SEK": CurrencyLocalization._(
      displayName: r"Ruotâ ruvnâ",
      displayCountSingular: null,
      displayCountPlural: null,
    ),
  },
